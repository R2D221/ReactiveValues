...
internal static class ILReaderFactory
{
...
[UnconditionalSuppressMessage("Trimming", "IL2026:Members annotated with 'RequiresUnreferencedCodeAttribute' require dynamic access otherwise can break functionality when trimming application code", Justification = "Uses reflection on internal types and is not trim-compatible.")]
internal sealed class ILReader : IEnumerable<ILInstruction>
{
...
internal sealed class InlineNoneInstruction : ILInstruction
{
...
internal sealed class InlineBrTargetInstruction : ILInstruction
{
...
internal sealed class ShortInlineBrTargetInstruction : ILInstruction
{
...
internal sealed class InlineSwitchInstruction : ILInstruction
{
...
internal sealed class InlineIInstruction : ILInstruction
{
...
internal sealed class InlineI8Instruction : ILInstruction
{
...
internal sealed class ShortInlineIInstruction : ILInstruction
{
...
internal sealed class ShortInlineRInstruction : ILInstruction
{
...
internal sealed class InlineFieldInstruction : ILInstruction
{
...
internal sealed class InlineMethodInstruction : ILInstruction
{
...
internal sealed class InlineTypeInstruction : ILInstruction
{
...
internal sealed class InlineSigInstruction : ILInstruction
{
...
internal sealed class InlineTokInstruction : ILInstruction
{
...
internal sealed class InlineStringInstruction : ILInstruction
{
...
internal sealed class InlineVarInstruction : ILInstruction
{
...
internal sealed class ShortInlineVarInstruction : ILInstruction
{
...
[UnconditionalSuppressMessage("Trimming", "IL2026:Members annotated with 'RequiresUnreferencedCodeAttribute' require dynamic access otherwise can break functionality when trimming application code", Justification = "Uses reflection on internal types and is not trim-compatible.")]
internal sealed class ModuleScopeTokenResolver : ITokenResolver
{
