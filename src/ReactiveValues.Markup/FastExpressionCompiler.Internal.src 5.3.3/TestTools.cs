...
internal static class Asserts
{
	...
	internal record struct ItemsCompared<T>(int Index, bool IsEqual, T Expected, T Actual);
...
internal interface ITestX
{
	void Run(TestRun tr);
}

internal enum AssertKind
{
	CommandedToFail,
	IsTrue,
	IsFalse,
...
internal record struct TestFailure(
	string TestMethodName,
	int SourceLineNumber,
	AssertKind Kind,
	string Message);

internal record struct TestStats(
	string TestsName,
